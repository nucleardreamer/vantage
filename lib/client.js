  ...
  return new Promise(function(resolve, reject) {
    ...
    ssn.client.on("connect", function() {
      ...
      if(!self.parent.headless) {
        ...
        // dont know if this should be included in non-interactive yet
      ...
      ssn.client.on("vantage-ssn-stdout-downstream", function(data) {
        self.parent._proxy("vantage-ssn-stdout-downstream", "downstream", data).then(function() {
          ...
          if (sessn) {
            ...
            // disconnect at the end of the first output if headless
            if(self.parent.headless){
              disconnect(void 0, function(){
                process.exit(0)
              })
            }
          }
